...
public class RsaTest {
        ...
        public void performance_1() {
            new PerformanceTest() {
                ...
                public void onFinished() {
                    ...
                    Assert.assertArrayEquals(privateKey.getEncoded(), Rsa.getPrivateKey(Rsa.getPrivateKeyBase64String(privateKey)).getEncoded());
    ...
    public static class encrypt {
        ...
        @Test(expected = IllegalArgumentException.class)
        public void error_4() {
            PublicKey key = new RSAPublicKey() {
                @Override
        ...
        @Test(expected = IllegalArgumentException.class)
        public void error_5() throws Exception {
