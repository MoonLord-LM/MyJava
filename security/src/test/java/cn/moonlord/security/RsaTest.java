...
public class RsaTest {
    ...
    public static synchronized void init() {
        ...
        logger.info("init, publicKeyBytes: " + Hex.encode(Rsa.getPublicKeyBytes(publicKey)).length());
        logger.info("init, privateKeyBytes: " + Hex.encode(Rsa.getPrivateKeyBytes(privateKey)).length());
        logger.info("init, publicKeyBase64String: " + Rsa.getPublicKeyBase64String(publicKey).length());
        logger.info("init, privateKeyBase64String: " + Rsa.getPrivateKeyBase64String(privateKey).length());
